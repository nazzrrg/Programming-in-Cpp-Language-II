...
cubeView::cubeView(bool graphical_, float screenWidth_, float screenHeight_) {
    ...
    if (graphical) {
        ...
        projection = glm::perspective(45.0f, screenWidth/screenHeight, 0.1f, 2000.0f) * glm::lookAt(glm::vec3(6.0, 3.0, 6.0), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
        
        shader = new Shader{"res/shaders/core.vs", "res/shaders/core.frag"};
    }
}
...
float cubeView::getScreenWidth() {
    return screenWidth;
}

float cubeView::getScreenHeight() {
    return screenHeight;
}

void cubeView::setScreenWidth(float width_) {
    screenWidth = width_;
}

void cubeView::setScreenHeight(float height_) {
    screenHeight = height_;
}

void cubeView::setProjection(glm::mat4 projection_) {
    projection = projection_;
}

void cubeView::updateProjection() {
    projection = glm::perspective(45.0f, screenWidth/screenHeight, 0.1f, 2000.0f) * glm::lookAt(glm::vec3(6.0, 3.0, 6.0), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
//    glViewport(0,0, (GLuint) screenWidth, (GLuint) screenHeight);
}
